...
function Sidebar() {
  return (
    <div className="bg-light border-end d-sm-block" style={{ width: "220px", height: "100vh" }}>
      ...
      <div className="flex-column p-2 text-dark" style={{ fontSize: "1.3rem" }}>
        <Link to="/task-list" className="d-flex text-dark align-items-center ms-3 text-decoration-none mb-4">
          <FaHome className="me-3" />
          TaskList
        </Link>

        <Link to="/employees" className="d-flex text-dark align-items-center ms-3 text-decoration-none mb-4">
          <FaUsers className="me-3" />
          Employees
        </Link>

        <a href="#" className="d-flex text-dark align-items-center ms-3 text-decoration-none mb-4">
